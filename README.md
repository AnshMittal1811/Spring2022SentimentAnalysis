...
The requirements for this project were as follows. 
  ...
  * **Plot** the number of messages per day and the average sentiment per day using the plotly visualization library. Please include a screenshot of this plot in your deliverable.
